  ...
  return (
    ...
    >
      ...
      <div className="flex min-h-0 flex-1 flex-col md:flex-row">
        ...
        {/* ─── Main content ─── */}
        <main className="thin-scrollbar flex min-h-0 min-w-0 flex-1 flex-col overflow-x-hidden overflow-y-auto p-3 pb-[calc(4.5rem+env(safe-area-inset-bottom,0px))] sm:p-5 md:pb-5 md:p-8">
